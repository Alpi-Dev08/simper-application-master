            ...
            <div class="container-fluid">
                            ...
                            <form action="{{route('user.search')}}" method="GET" class="form-horizontal">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-3 text-right control-label col-form-label">berdasarkan nama karyawan</label>
                                        <div class="col-sm-9">
                                            <input type="text" name="search" class="form-control" id="fname" placeholder="nama karyawan">
                                        </div>
                                    </div>
                                </div>
                                <div class="border-top">
                                    <div class="card-body">
                                        ...
                                        <a href="{{route('user')}}" class="btn btn-md btn-danger">Batal</a>
                                    </div>
                                </div>
                            </form>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title m-b-0">Daftar Pengguna</h5>
                            </div>
                                        ...
                                        <td>
                                            <button type="button"
                                                ...
                                                <div class="btn-group" role="group" aria-label="Basic example">
                                                    <a href="{{route('user.edit',$user->id)}}" class="btn btn-sm btn-dark mr-1">Edit</a>
