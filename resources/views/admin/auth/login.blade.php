...
<!--     <link rel="icon" type="image/png" sizes="16x16" href="{{asset('admin-panel/assets/images/favicon.png')}}">
 -->    <title>E-Cuti Honda Bintaro</title>
    <!-- Custom CSS -->
                    ...
                    <div class="row p-b-30">
                        <div class="col-12">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="password" name="password" class="form-control form-control-lg{{ $errors->has('password') ? ' is-invalid' : '' }}" placeholder="Kata Sandi" aria-label="Kata Sandi" aria-describedby="basic-addon1" required="">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                <div class="p-t-20">
                                    ...
                                    <button class="btn btn-outline-info btn-lg btn-block" type="submit">Masuk</button>
                                </div>
                            </div>
                        </div>
                    </div>
